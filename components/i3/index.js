      ...
      <div className={styles.leftColumn}>
        ...
        <div className={styles.featureItem}>
          ...
          <div className={styles.featureText}>
            ...
            <p>
              As you enter text, the system will automatically translate it into
        ...
        <div className={styles.featureItem}>
          ...
          <div className={styles.featureText}>
            ...
            <p>
              When you use this function, the sound will be converted into
              animation.
            </p>
          </div>
        </div>
        ...
        <div className={styles.featureItem}>
          ...
          <div className={styles.featureText}>
            ...
            <p>
              You just need to record a video of someone using sign language and
      ...
      <div className={styles.rightColumn}>
        <div className={styles.demoWrapper}>
          ...
          <div className={styles.resultBox}>
            ...
            <h2 className={styles.resultLetter}>{predictionData.result}</h2>
            ...
            >
              <div
                style={{
                  width: `${(predictionData.confidence * 100).toFixed(0)}%`,
                  background: "#8A79DF",
                  height: 8,
                  borderRadius: 8,
                }}
